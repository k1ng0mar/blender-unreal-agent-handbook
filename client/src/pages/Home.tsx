  ...
  return (
    <main className="min-h-screen bg-[#ecebe2] text-[#1e241d]">
      <section className="grain relative overflow-hidden bg-[#171a16] text-[#f6f3e8]">
        ...
        <div className="absolute inset-0 bg-cover bg-center opacity-75 mix-blend-screen" />
