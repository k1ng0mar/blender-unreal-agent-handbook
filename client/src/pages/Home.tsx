...
function FieldMark() {
  return (
    <img src="/images/field-engine-mark.png" alt="" className="h-10 w-10 rounded-sm object-cover" />
  );
}
  ...
  return (
    <main className="min-h-screen bg-[#ecebe2] text-[#1e241d]">
      <section className="grain relative overflow-hidden bg-[#171a16] text-[#f6f3e8]">
        ...
        <div className="absolute inset-0 bg-cover bg-center opacity-75 mix-blend-screen" style={{ backgroundImage: "url('/images/field-engine-hero.png')" }} />
        ...
        <div className="mx-auto max-w-[1320px]">
          ...
          <div className="mt-14 grid gap-6 lg:grid-cols-[1fr_.9fr]">
            ...
            <div className="overflow-hidden border border-[#c8c7ba] bg-[#1c211c] text-[#eff0e8]">
              <img src="/images/agent-bridge.png" alt="Abstract visualization of an agent bridge between a mesh graph and a built world" className="h-[210px] w-full object-cover opacity-80" />
